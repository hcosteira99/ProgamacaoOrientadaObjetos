...
public abstract class Jogador {
    ...
    public abstract void setEquipaAtual(String nome);
    
    public abstract void addEquipa(String nome);
    
    public abstract void setOverall();
    
    public abstract List<String> getEquipas();
    
    public abstract void setEquipasZero();
    
    public boolean equals(Object obj) {
        if(obj==this) return true;
        if(obj==null || obj.getClass() != this.getClass()) return false;
        Jogador le = (Jogador) obj;
        return le.getVelocidade()==(this.velocidade) &&
              le.getResistencia()==(this.resistencia) && 
              le.getDestreza()==(this.destreza) &&
              le.getImpulsao()==(this.impulsao) &&
              le.getCabeca()==(this.cabeca) &&
              le.getRemate()==(this.remate) &&
              le.getPasse()==(this.passe) &&
              le.getNomeJogador().equals(this.nomeJogador) &&
              le.getNumeroJogador()==(this.numeroJogador);
    }
    
    
    
    public String toString(){
        return nomeJogador +" "+numeroJogador;
    }
